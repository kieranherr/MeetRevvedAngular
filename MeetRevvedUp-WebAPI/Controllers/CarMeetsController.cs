...
namespace MeetRevvedUp_WebAPI.Controllers
{
    ...
    public class CarMeetsController : Controller
    {
        ...
        public CarMeetsController(RevvedUpContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                var geocodeResults = JsonSerializer.Deserialize<IGeocodeJson>(responseBody, new JsonSerializerOptions { PropertyNameCaseInsensitive = true })?.Results;
